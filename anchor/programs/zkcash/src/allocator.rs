/*
Copied from https://github.com/Squads-Protocol/v4/blob/eef4552a7c3f12517a907b7a979b1aa0d4c36f9d/programs/squads_multisig_program/src/allocator.rs
...
// Only use the allocator when targeting Solana and not in a no-entrypoint context
